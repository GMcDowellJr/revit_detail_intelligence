...
- Similarity Matching Document
- Runtime Storage and v0.3.2 Operational Notes
- to_dynamo_score_list
- graphify
...
- find_similar_views
- extraction-spec.md
- Contributing: Branch + CI-gated Workflow
- Dynamo IN/OUT Entrypoint Interface
...
### Community 0 - "view_feature_cache.py"
Cohesion: 0.09
Nodes (50): _bundle_from_dict(), _bundle_to_dict(), cache_file_for_view(), deserialize_cache_entry(), _doc_scope_from_bundle(), _doc_scope_from_source(), get_cached_bundle_with_diagnostics(), invalidate_cache_record() (+42 more)

### Community 1 - "dynamo_view_similarity_legacy.py"
Cohesion: 0.07
...
### Community 3 - "IndexDiagnosticAccumulator"
Cohesion: 0.07
...
### Community 12 - "preview_export.py"
Cohesion: 0.22
...
### Community 13 - "dynamo_thin_runner.py"
Cohesion: 0.18
...
### Community 14 - "test_feature_cache.py"
Cohesion: 0.31
...
### Community 15 - "audit_unresolved_comments.py"
Cohesion: 0.24
...
- **Should `view_feature_cache.py` be split into smaller, more focused modules?**
  _Cohesion score 0.08819538670284939 - nodes in this community are weakly interconnected._