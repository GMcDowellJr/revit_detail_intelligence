...
Cohesion: 0.08
Nodes (54): _bundle_from_dict(), _bundle_to_dict(), cache_file_for_view(), deserialize_cache_entry(), _doc_scope_from_bundle(), _doc_scope_from_source(), get_cached_bundle_with_diagnostics(), invalidate_cache_record() (+46 more)
...
Cohesion: 0.09
Nodes (43): _build_state_context(), _bundle_source_scope(), collect_token_data_for_view(), _doc_provenance(), _doc_scoped_cache_path(), _elapsed_ms(), element_base_info(), _extract_bundle_for_index() (+35 more)

### Community 5 - "IO Paths and File Routing"
Cohesion: 0.10
Nodes (36): ensure_dir(), resolve_contacts_dir(), resolve_many_to_many_dir(), resolve_output_root(), resolve_preview_cache_dir(), run_stamp(), _cand_file_name(), _copy_if_present() (+28 more)

### Community 6 - "Feature Cache Abstraction"
Cohesion: 0.06
Nodes (30): AGENTS.md — Revit Detail Intelligence, ChatGPT (web / API without project context), graphify, graphify explain, graphify — graph-first codebase navigation, graphify query, Key entry points, Project overview (+22 more)
...
Cohesion: 0.24
Nodes (6): apply_geom_dominant_suppression(), derive_min_token_threshold(), explain_match(), fine_similarity(), gaussian_sim(), top_shared_bins()
...
Cohesion: 0.22
Nodes (16): bbox_aspect_ratio(), build_fine_metrics(), linework_density(), bbox(), bbox_diagonal(), collect_curves_from_geometry(), _collect_points_for_curve(), _curve_angular_span_degrees() (+8 more)
...
Cohesion: 0.22
Nodes (9): build_config_snapshot(), classify_cache_temperature(), distribution_stats(), percentile(), resolve_index_sidecar_path(), resolve_search_sidecar_path(), _utc_now_iso(), test_classify_cache_temperature_deterministic() (+1 more)
...
Cohesion: 0.39
Nodes (6): default_idf_for_doc_count(), bin_index(), geom_fingerprint_knn(), k_nearest_neighbors(), normalize_l1(), robust_scale()
...
Cohesion: 0.20
Nodes (9): find_similar_views, search, symbol_raster_pipeline, write_json_sidecar(), build_token_df_from_features(), build_token_idf(), check_feature_richness(), effective_weights() (+1 more)

## Knowledge Gaps
- **116 isolated node(s):** `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed`, `Step 2 - Detect files` (+111 more)
...
- **Why does `collect_token_data_for_view()` connect `Symbol Cache Layer` to `Legacy Similarity Script`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `ViewFeatures` connect `Legacy Similarity Script` to `Similarity Search Pipeline`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `type_signature()` connect `Legacy Similarity Script` to `Symbol Raster Pipeline`, `Symbol Cache Layer`?**
